                    ...
                    <div class="formstyle">
                        ...
                        <form class="form-horizontal" action="/action_page.php">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" class="form-control" id="email" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="pwd">Your Email:</label>
                                <div class="col-sm-6"> 
                                    <input type="email" class="form-control" id="pwd" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="pwd">Company Name: </label>
                                <div class="col-sm-6"> 
                                    <input type="name" class="form-control" id="pwd" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
