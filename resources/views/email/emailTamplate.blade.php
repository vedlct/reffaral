...
<head>
    ...
    <style type="text/css">
        ...
        button {
            background: #56dcf5 none repeat scroll 0 0;
            border: none;
            color: #fff;
            padding: 5px 22px;
            border-radius: 2px;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
    <tr>
        <td><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#EEEEEE" style="font-family:helvetica, sans-serif;" class="MainContainer">
                <!-- =============== START HEADER =============== -->
                <tbody>
                <tr>
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" width="580"><div class='contentEditableContainer contentImageEditable'>
                                                                                            <div class='contentEditable' style="text-align: center;"><img class="banner" src="{{url('public/img/image1.jpg')}}" alt="Logo" title="Logo" width="580" height="80" border="0"></div></div></td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style='text-align: left;'>
                                                                                                <p style="font-size: 15px; text-align: center;">&copy; TechCloud Ltd 2018. All rights reserved</p>
